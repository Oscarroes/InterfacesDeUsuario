...
#FUNCION ELIMINAR  
def eliminar():
    IDcontacto = idVar.get()
    arbol.delete(IDcontacto) 
...
def abrirVentana(event):
    ...
    global nombreVar, apellidosVar, telefonoVar, emailVar, idVar, idModVar, nombreModVar, apellidosModVar, telefonoModVar, emailModVar
    if opciones.get() == 'Nuevo Contacto':
        ...
        ventanaModificar.geometry("450x600")

        headModLabel1 = ttk.Label(ventanaModificar,text="Introduce el ID del contacto a modificar",font=("Arial",12,"bold"),background="#E7B312")
        idLabel = ttk.Label(ventanaModificar,text="Introduce el ID:",anchor='w',width=25,background="#E7B312")
        idSpin = ttk.Spinbox(ventanaModificar,from_=0,to=100,textvariable=idModVar)

        headModLabel2 = ttk.Label(ventanaModificar,text="Introduce los nuevos datos",font=("Arial",12,"bold"),background="#E7B312")
        ...
        headModLabel1.grid(row=0,column=0,columnspan=2,padx=30,pady=30)
        idLabel.grid(row=1,column=0,padx=30,pady=10)
        idSpin.grid(row=1,column=1,padx=30,pady=10)
        headModLabel2.grid(row=2,column=0,columnspan=2,padx=30,pady=30)
        nombreModLabel.grid(row=3,column=0,padx=30,pady=10)
        nombreModEntry.grid(row=3,column=1,padx=30,pady=10)
        apellidosModLabel.grid(row=4,column=0,padx=30,pady=10)
        apellidosModEntry.grid(row=4,column=1,padx=30,pady=10)
        telefonoModLabel.grid(row=5,column=0,padx=30,pady=10)
        telefonoModEntry.grid(row=5,column=1,padx=30,pady=10)
        emailModLabel.grid(row=6,column=0,padx=30,pady=10)
        emailModEntry.grid(row=6,column=1,padx=30,pady=10)
        botonModificar.grid(row=7,column=0,columnspan=2,padx=30,pady=30)
        ...
        headDelLabel1 = ttk.Label(ventanaEliminar,text="Introduce el ID del contacto a elminar",background="#F6381D",font=("Arial",12,"bold"))
        idDelLabel = ttk.Label(ventanaEliminar,text="Introduce el ID:",anchor='w',width=25,background="#F6381D")
        idDelSpin = ttk.Spinbox(ventanaEliminar,from_=0,to=100,textvariable=idVar)
        BotonEliminar = ttk.Button(ventanaEliminar,text="Eliminar Contacto",command=eliminar, style="Red.TButton")

        headDelLabel1.grid(row=0,column=0,columnspan=2,padx=30,pady=30)
        idDelLabel.grid(row=1,column=0,padx=30,pady=10)
        idDelSpin.grid(row=1,column=1,padx=30,pady=10)
        BotonEliminar.grid(row=2,column=0,columnspan=2,padx=30,pady=30)
